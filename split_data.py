...
def main():
    ...
    split_rate = 0.2
    # 解压后的文件夹名称（当前路径下）
    data_root_after_unzip = "newdata-8_2"
    # 原数据集文件夹（当前路径下）
    origin_data_root = "newdata——origin"



    # 指向你解压后的flower_photos文件夹
    cwd = os.getcwd()
    data_root = os.path.join(cwd, data_root_after_unzip)
    origin_data_path = os.path.join(cwd, origin_data_root)
